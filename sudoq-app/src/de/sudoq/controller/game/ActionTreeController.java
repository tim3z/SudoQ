...
public class ActionTreeController implements ActionTreeNavListener, ModelChangeListener<ActionTreeElement> {
	...
	private void drawLine(int fromX, int fromY, int toX, int toY) {
		...
		BranchingLine branchingLine = new BranchingLine(this.context);
		branchingLine.setSize((toY * AT_RASTER_SIZE) - fromY * AT_RASTER_SIZE,
				(toX * AT_RASTER_SIZE + AT_RASTER_SIZE / 2) - fromX * AT_RASTER_SIZE);
