 ...
 * 
 * @see ViewClickListener
 */
public interface ObservableViewClicked {
	 ...
	 */
	void registerListener(ViewClickListener listener);
	 ...
	 */
	void removeListener(ViewClickListener listener);
}
